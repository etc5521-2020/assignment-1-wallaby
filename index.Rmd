...
TSD <- SwiftPop %>% ggplot() + geom_point(aes(x = danceability, y = track_name), color = "blue") +
  ...
  theme(axis.text.y = element_blank()) + xlab("Danceability") + ylab("Track Name")
