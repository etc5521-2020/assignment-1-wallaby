...
The **variables** in this dataset are `r names(spotify_songs)`.
...
```{r coldplay-valence, fig.height=3.5}
coldplay %>% 
  group_by(album_name) %>% 
...
```{r time-popular, fig.width=5, fig.height=5}
spotify_songs <- spotify_songs %>% 
