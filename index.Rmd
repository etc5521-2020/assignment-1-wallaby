...
By doing this exploratory data analysis, we want to konw: What musical attributes are capable of making an impact on the popularity of music artworks and contribute to the emergence of Top Songs?
...
```{r artists, fig.cap="Top 20 Artists who wrote the most songs from 1941 to 2020", fig.align='center', fig.height=3.5}
new_data1 %>% 
  count(track_artist) %>% 
  arrange(-n) %>% 
  head(20) %>%
...
```{r coldplay-album, tab.align='center', tab.height=3.5}
...
```{r my favorate-album-lyrics, cache=TRUE, tab.align='center', tab.height=3.5}
...
```{r features-popularity, tab.align='center', tab.height=3.5}
...
The table below shows the distribution of each genre in this dataset. The most frequently appeared genre is "edm", while the genre "rock" appeared least.

```{r genres-summary, tab.align='center', tab.height=3.5}
spotify_songs %>% 
